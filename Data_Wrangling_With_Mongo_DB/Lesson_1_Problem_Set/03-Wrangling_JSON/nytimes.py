...
def article_overview(kind, period):
    ...
    for article in data: 
        ...
        for article_metadata in article['media']: 
            for article_format in article_metadata['media-metadata']: 
                if article_format['format'] == "Standard Thumbnail": 
                    urls.append(article_format['url']) 
